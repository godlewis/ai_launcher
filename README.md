...
一个强大的Windows桌面AI工具启动器，支持多AI工具快速启动和工作目录右键菜单集成。

![AI启动器](app.ico) ![右键菜单](logo.ico)

## 🚀 功能特性

### 核心功能
- 🤖 **多AI工具支持**：一键启动Claude、Qwen、Codex三个AI工具
- ⌨️ **键盘快捷键**：支持数字键1、2、3快速启动
...
| 文件 | 说明 |
|------|------|
| `ai_launcher.exe` | 主程序 - AI工具启动器 |
| `registry_manager.exe` | 右键菜单管理器 |
